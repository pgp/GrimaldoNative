 ...
 */
unsigned long long crypto_sign_secretkeybytes();

/*
 * Returns the length of a public key, in bytes
 */
unsigned long long crypto_sign_publickeybytes();

/*
 * Returns the length of a signature, in bytes
 */
unsigned long long crypto_sign_bytes();

/*
 * Returns the length of the seed required to generate a key pair, in bytes
 */
unsigned long long crypto_sign_seedbytes();
